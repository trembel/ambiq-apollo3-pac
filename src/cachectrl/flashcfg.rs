...
pub enum LPMMODE_A {
    ...
    STANDBY = 1,
    #[doc = "2: Low Power mode.  LPM always asserted for reads.  LPM_RD_WAIT must be programmed to accomodate longer read access times."]
    ALWAYS = 2,
}
...
impl<'a> LPMMODE_W<'a> {
    ...
    #[doc = "Low Power mode. LPM always asserted for reads. LPM_RD_WAIT must be programmed to accomodate longer read access times."]
    #[inline(always)]
