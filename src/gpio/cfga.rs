...
pub enum GPIO7INTD_A {
    #[doc = "0: FNCSEL = 0x0 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: FNCSEL = 0x0 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO7INTD_W<'a> {
    ...
    #[doc = "FNCSEL = 0x0 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO7INTD_A::NCELOW)
    }
    #[doc = "FNCSEL = 0x0 - nCE polarity active high"]
    #[inline(always)]
...
pub enum GPIO7OUTCFG_A {
    #[doc = "0: FNCSEL = 0x3 - Output disabled"]
    DIS = 0,
    #[doc = "1: FNCSEL = 0x3 - Output is push-pull"]
    PUSHPULL = 1,
    #[doc = "2: FNCSEL = 0x3 - Output is open drain"]
    OD = 2,
    #[doc = "3: FNCSEL = 0x3 - Output is tri-state"]
    TS = 3,
}
...
pub enum GPIO7INCFG_A {
    ...
    READ = 0,
    #[doc = "1: INTD = 0 - Readback will always be zero"]
    RDZERO = 1,
}
...
impl<'a> GPIO7INCFG_W<'a> {
    ...
    #[doc = "INTD = 0 - Readback will always be zero"]
    #[inline(always)]
...
pub enum GPIO6INTD_A {
    #[doc = "0: INCFG = 1 - No interrupt on GPIO transition"]
    INTDIS = 0,
    #[doc = "1: INCFG = 1 - Interrupt on either low to high or high to low GPIO transition"]
    INTBOTH = 1,
}
...
impl<'a> GPIO6INTD_W<'a> {
    ...
    #[doc = "INCFG = 1 - No interrupt on GPIO transition"]
    #[inline(always)]
    pub fn intdis(self) -> &'a mut W {
        self.variant(GPIO6INTD_A::INTDIS)
    }
    #[doc = "INCFG = 1 - Interrupt on either low to high or high to low GPIO transition"]
    #[inline(always)]
...
pub enum GPIO4INTD_A {
    #[doc = "0: FNCSEL = 0x2 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: FNCSEL = 0x2 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO4INTD_W<'a> {
    ...
    #[doc = "FNCSEL = 0x2 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO4INTD_A::NCELOW)
    }
    #[doc = "FNCSEL = 0x2 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
...
pub enum GPIO2INTD_A {
    #[doc = "0: FNCSEL = 0x7 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: FNCSEL = 0x7 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO2INTD_W<'a> {
    ...
    #[doc = "FNCSEL = 0x7 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO2INTD_A::NCELOW)
    }
    #[doc = "FNCSEL = 0x7 - nCE polarity active high"]
    #[inline(always)]
    pub fn n_cehigh(self) -> &'a mut W {
