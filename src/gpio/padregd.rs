...
pub enum PAD15FNCSEL_A {
    #[doc = "0: Configure as the analog ADC differential pair 1 N input signal"]
    ADCD1N = 0,
    #[doc = "1: IOM/MSPI nCE group 15"]
    NCE15 = 1,
    #[doc = "2: Configure as the UART1 RX signal"]
    UART1RX = 2,
    #[doc = "3: Configure as GPIO15"]
    GPIO15 = 3,
    #[doc = "4: PDM serial data input"]
    PDMDATA = 4,
    #[doc = "5: Configure as the external XTAL oscillator input"]
    EXTXT = 5,
    #[doc = "6: Configure as an alternate port for the SWDIO I/O signal"]
    SWDIO = 6,
    #[doc = "7: Configure as an SWO (Serial Wire Trace output)"]
    SWO = 7,
}
...
impl<'a> PAD15FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the analog ADC differential pair 1 N input signal"]
    #[inline(always)]
    pub fn adcd1n(self) -> &'a mut W {
        self.variant(PAD15FNCSEL_A::ADCD1N)
    }
    #[doc = "IOM/MSPI nCE group 15"]
    #[inline(always)]
    ...
    #[doc = "Configure as an alternate port for the SWDIO I/O signal"]
    #[inline(always)]
    pub fn swdio(self) -> &'a mut W {
        self.variant(PAD15FNCSEL_A::SWDIO)
    }
    #[doc = "Configure as an SWO (Serial Wire Trace output)"]
    #[inline(always)]
...
pub enum PAD14FNCSEL_A {
    #[doc = "0: Configure as the analog ADC differential pair 1 P input signal"]
    ADCD1P = 0,
    #[doc = "1: IOM/MSPI nCE group 14"]
    NCE14 = 1,
    #[doc = "2: Configure as the UART1 TX output signal"]
    UART1TX = 2,
    #[doc = "3: Configure as GPIO14"]
    GPIO14 = 3,
    #[doc = "4: PDM serial clock output"]
    PDMCLK = 4,
    #[doc = "5: Configure as the External HFRC oscillator input select"]
    EXTHFS = 5,
    #[doc = "6: Configure as the alternate input for the SWDCK input signal"]
    SWDCK = 6,
    #[doc = "7: Configure as the 32kHz crystal output signal"]
    _32KHZXT = 7,
}
...
impl<'a> PAD14FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the analog ADC differential pair 1 P input signal"]
    #[inline(always)]
    pub fn adcd1p(self) -> &'a mut W {
        self.variant(PAD14FNCSEL_A::ADCD1P)
    }
    #[doc = "IOM/MSPI nCE group 14"]
    #[inline(always)]
    ...
    #[doc = "PDM serial clock output"]
    #[inline(always)]
    pub fn pdmclk(self) -> &'a mut W {
        self.variant(PAD14FNCSEL_A::PDMCLK)
    }
    #[doc = "Configure as the External HFRC oscillator input select"]
    #[inline(always)]
    pub fn exthfs(self) -> &'a mut W {
        self.variant(PAD14FNCSEL_A::EXTHFS)
    }
    #[doc = "Configure as the alternate input for the SWDCK input signal"]
    #[inline(always)]
...
pub enum PAD13FNCSEL_A {
    #[doc = "0: Configure as the ADC Differential pair 0 P, or Single Ended input 8 analog input signal. Determination of the D0P vs SE8 usage is done when the particular channel is selected within the ADC module"]
    ADCD0PSE8 = 0,
    #[doc = "1: IOM/MSPI nCE group 13"]
    NCE13 = 1,
    #[doc = "2: CTIMER connection 2"]
    CT2 = 2,
    #[doc = "3: Configure as GPIO13"]
    GPIO13 = 3,
    #[doc = "4: I2C interface bit clock"]
    I2SBCLK = 4,
    #[doc = "5: Configure as the external HFRC oscillator input"]
    EXTHFB = 5,
    #[doc = "6: Configure as the UART0 RTS signal output"]
    UA0RTS = 6,
    #[doc = "7: Configure as the UART1 RX input signal"]
    UART1RX = 7,
}
...
impl<'a> PAD13FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the ADC Differential pair 0 P, or Single Ended input 8 analog input signal. Determination of the D0P vs SE8 usage is done when the particular channel is selected within the ADC module"]
    #[inline(always)]
    pub fn adcd0pse8(self) -> &'a mut W {
        self.variant(PAD13FNCSEL_A::ADCD0PSE8)
    }
    #[doc = "IOM/MSPI nCE group 13"]
    #[inline(always)]
    ...
    #[doc = "Configure as the UART0 RTS signal output"]
    #[inline(always)]
...
pub enum PAD12FNCSEL_A {
    #[doc = "0: Configure as the ADC Differential pair 0 N, or Single Ended input 9 analog input signal. Determination of the D0N vs SE9 usage is done when the particular channel is selected within the ADC module"]
    ADCD0NSE9 = 0,
    #[doc = "1: IOM/MSPI nCE group 12"]
    NCE12 = 1,
    #[doc = "2: CTIMER connection 0"]
    CT0 = 2,
    #[doc = "3: Configure as GPIO12"]
    GPIO12 = 3,
    #[doc = "5: PDM serial clock output"]
    PDMCLK = 5,
    #[doc = "6: Configure as the UART0 CTS input signal"]
    UA0CTS = 6,
    #[doc = "7: Configure as the UART1 TX output signal"]
    UART1TX = 7,
}
...
impl PAD12FNCSEL_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, PAD12FNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(PAD12FNCSEL_A::ADCD0NSE9),
            1 => Val(PAD12FNCSEL_A::NCE12),
            2 => Val(PAD12FNCSEL_A::CT0),
            3 => Val(PAD12FNCSEL_A::GPIO12),
            5 => Val(PAD12FNCSEL_A::PDMCLK),
            6 => Val(PAD12FNCSEL_A::UA0CTS),
            7 => Val(PAD12FNCSEL_A::UART1TX),
            i => Res(i),
        }
    }
...
impl<'a> PAD12FNCSEL_W<'a> {
    ...
    #[doc = "Configure as the ADC Differential pair 0 N, or Single Ended input 9 analog input signal. Determination of the D0N vs SE9 usage is done when the particular channel is selected within the ADC module"]
    #[inline(always)]
    pub fn adcd0nse9(self) -> &'a mut W {
        self.variant(PAD12FNCSEL_A::ADCD0NSE9)
    }
    #[doc = "IOM/MSPI nCE group 12"]
    #[inline(always)]
