...
pub enum PAD23FNCSEL_A {
    ...
    I2SWCLK = 4,
    #[doc = "5: Configure as voltage comparitor output"]
    CMPOUT = 5,
    #[doc = "6: MSPI data connection 3"]
    MSPI3 = 6,
    #[doc = "7: External XTAL osacillatgor input"]
    EXTXT = 7,
}
...
impl<'a> PAD23FNCSEL_W<'a> {
    ...
    #[doc = "Configure as voltage comparitor output"]
    #[inline(always)]
    ...
    #[doc = "External XTAL osacillatgor input"]
    #[inline(always)]
