...
pub enum GPIO47INTD_A {
    #[doc = "0: FNCSEL = 0x1 - nCE polarity active low"]
    NCELOW = 0,
    #[doc = "1: FNCSEL = 0x1 - nCE polarity active high"]
    NCEHIGH = 1,
}
...
impl<'a> GPIO47INTD_W<'a> {
    ...
    #[doc = "FNCSEL = 0x1 - nCE polarity active low"]
    #[inline(always)]
    pub fn n_celow(self) -> &'a mut W {
        self.variant(GPIO47INTD_A::NCELOW)
    }
    #[doc = "FNCSEL = 0x1 - nCE polarity active high"]
    #[inline(always)]
