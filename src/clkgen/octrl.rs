...
pub enum ACAL_A {
    ...
    DIS = 0,
    #[doc = "2: Autocalibrate every 1024 seconds.  Once autocalibration is done, an interrupt will be triggered at the end of 1024 seconds."]
    _1024SEC = 2,
    #[doc = "3: Autocalibrate every 512 seconds.  Once autocalibration is done, an interrupt will be trigged at the end of 512 seconds."]
    _512SEC = 3,
    #[doc = "6: Frequency measurement using XT.  The XT clock is normally considered much more accurate than the LFRC clock source."]
    XTFREQ = 6,
...
impl<'a> ACAL_W<'a> {
    ...
    #[doc = "Autocalibrate every 1024 seconds. Once autocalibration is done, an interrupt will be triggered at the end of 1024 seconds."]
    #[inline(always)]
    pub fn _1024sec(self) -> &'a mut W {
        self.variant(ACAL_A::_1024SEC)
    }
    #[doc = "Autocalibrate every 512 seconds. Once autocalibration is done, an interrupt will be trigged at the end of 512 seconds."]
    #[inline(always)]
    pub fn _512sec(self) -> &'a mut W {
        self.variant(ACAL_A::_512SEC)
    }
    #[doc = "Frequency measurement using XT. The XT clock is normally considered much more accurate than the LFRC clock source."]
    #[inline(always)]
