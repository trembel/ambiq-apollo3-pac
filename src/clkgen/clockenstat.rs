...
pub enum CLOCKENSTAT_A {
    ...
    #[doc = "1024: Clock enable for the APBDMA_PDM"]
    APBDMA_PDM_CLKEN = 1024,
    #[doc = "2048: Clock enable for the BLEIF"]
    BLEIF_CLK_CLKEN = 2048,
    #[doc = "4096: Clock enable for the BLEIF 32khZ CLOCK"]
    BLEIF_CLK32K_CLKEN = 4096,
    #[doc = "8192: Clock enable for the CTIMER BLOCK"]
    CTIMER_CLKEN = 8192,
    #[doc = "16384: Clock enable for the CTIMER0A"]
    CTIMER0A_CLKEN = 16384,
    #[doc = "32768: Clock enable for the CTIMER0B"]
    CTIMER0B_CLKEN = 32768,
    #[doc = "65536: Clock enable for the CTIMER1A"]
    CTIMER1A_CLKEN = 65536,
    #[doc = "131072: Clock enable for the CTIMER1B"]
    CTIMER1B_CLKEN = 131072,
    #[doc = "262144: Clock enable for the CTIMER2A"]
    CTIMER2A_CLKEN = 262144,
    #[doc = "524288: Clock enable for the CTIMER2B"]
    CTIMER2B_CLKEN = 524288,
    #[doc = "1048576: Clock enable for the CTIMER3A"]
    CTIMER3A_CLKEN = 1048576,
    #[doc = "2097152: Clock enable for the CTIMER3B"]
    CTIMER3B_CLKEN = 2097152,
    #[doc = "4194304: Clock enable for the CTIMER4A"]
    CTIMER4A_CLKEN = 4194304,
    #[doc = "8388608: Clock enable for the CTIMER4B"]
    CTIMER4B_CLKEN = 8388608,
    #[doc = "16777216: Clock enable for the CTIMER5A"]
    CTIMER5A_CLKEN = 16777216,
    #[doc = "33554432: Clock enable for the CTIMER5B"]
    CTIMER5B_CLKEN = 33554432,
    #[doc = "67108864: Clock enable for the CTIMER6A"]
    CTIMER6A_CLKEN = 67108864,
    #[doc = "134217728: Clock enable for the CTIMER6B"]
    CTIMER6B_CLKEN = 134217728,
    #[doc = "268435456: Clock enable for the CTIMER7A"]
    CTIMER7A_CLKEN = 268435456,
    #[doc = "536870912: Clock enable for the CTIMER7B"]
    CTIMER7B_CLKEN = 536870912,
    #[doc = "1073741824: Clock enable for the DAP"]
    DAP_CLKEN = 1073741824,
    #[doc = "2147483648: Clock enable for the IOMSTRIFC0"]
