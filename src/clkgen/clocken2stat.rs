...
pub enum CLOCKEN2STAT_A {
    #[doc = "1: Clock enable for the IO MASTER 1 IFC INTERFACE"]
    IOMSTRIFC1_CLKEN = 1,
    #[doc = "2: Clock enable for the IO MASTER 2 IFC INTERFACE"]
    IOMSTRIFC2_CLKEN = 2,
    #[doc = "4: Clock enable for the IO MASTER 3 IFC INTERFACE"]
    IOMSTRIFC3_CLKEN = 4,
    #[doc = "8: Clock enable for the IO MASTER 4 IFC INTERFACE"]
    IOMSTRIFC4_CLKEN = 8,
    #[doc = "16: Clock enable for the IO MASTER 5 IFC INTERFACE"]
    IOMSTRIFC5_CLKEN = 16,
    #[doc = "32: Clock enable for the PDM"]
    PDM_CLKEN = 32,
    #[doc = "64: Clock enable for the PDM INTERFACE"]
    PDMIFC_CLKEN = 64,
    #[doc = "128: Clock enable for the PWRCTRL"]
    PWRCTRL_CLKEN = 128,
    #[doc = "256: Clock enable for the PWRCTRL counter"]
    PWRCTRL_COUNT_CLKEN = 256,
    #[doc = "512: Clock enable for the RSTGEN"]
    RSTGEN_CLKEN = 512,
    #[doc = "1024: Clock enable for the SCARD"]
    SCARD_CLKEN = 1024,
    #[doc = "2048: Clock enable for the SCARD ALTAPB"]
    SCARD_ALTAPB_CLKEN = 2048,
    #[doc = "4096: Clock enable for the STIMER_CNT_CLKEN"]
    STIMER_CNT_CLKEN = 4096,
    #[doc = "8192: Clock enable for the TPIU_CLKEN"]
    TPIU_CLKEN = 8192,
    #[doc = "16384: Clock enable for the UART0 HF"]
    UART0HF_CLKEN = 16384,
    #[doc = "32768: Clock enable for the UART1 HF"]
    UART1HF_CLKEN = 32768,
    #[doc = "1073741824: Clock enable for the XT 32KHZ"]
    XT_32KHZ_EN = 1073741824,
    #[doc = "2147483648: HFRC is forced on Status."]
...
impl CLOCKEN2STAT_R {
    ...
    pub fn variant(&self) -> crate::Variant<u32, CLOCKEN2STAT_A> {
        ...
        match self.bits {
            ...
            256 => Val(CLOCKEN2STAT_A::PWRCTRL_COUNT_CLKEN),
            512 => Val(CLOCKEN2STAT_A::RSTGEN_CLKEN),
            1024 => Val(CLOCKEN2STAT_A::SCARD_CLKEN),
            2048 => Val(CLOCKEN2STAT_A::SCARD_ALTAPB_CLKEN),
            4096 => Val(CLOCKEN2STAT_A::STIMER_CNT_CLKEN),
            8192 => Val(CLOCKEN2STAT_A::TPIU_CLKEN),
            16384 => Val(CLOCKEN2STAT_A::UART0HF_CLKEN),
            32768 => Val(CLOCKEN2STAT_A::UART1HF_CLKEN),
