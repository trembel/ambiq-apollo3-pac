...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FLASH1EN_A {
    #[doc = "1: Enable FLASH status event"]
    EN = 1,
    #[doc = "0: Disables FLASH status event"]
    DIS = 0,
}
...
impl<'a> FLASH1EN_W<'a> {
    ...
    #[doc = "Enable FLASH status event"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(FLASH1EN_A::EN)
    }
    #[doc = "Disables FLASH status event"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
#[repr(u16)]
pub enum SRAMEN_A {
    #[doc = "0: Disable SRAM power-on status event"]
    NONE = 0,
    #[doc = "1: Enable SRAM group0 (0KB-32KB) power on status event"]
    GROUP0EN = 1,
    #[doc = "2: Enable SRAM group1 (32KB-64KB) power on status event"]
    GROUP1EN = 2,
    #[doc = "4: Enable SRAM group2 (64KB-96KB) power on status event"]
    GROUP2EN = 4,
    #[doc = "8: Enable SRAM group3 (96KB-128KB) power on status event"]
    GROUP3EN = 8,
    #[doc = "16: Enable SRAM group4 (128KB-160KB) power on status event"]
    GROUP4EN = 16,
    #[doc = "32: Enable SRAM group5 (160KB-192KB) power on status event"]
    GROUP5EN = 32,
    #[doc = "64: Enable SRAM group6 (192KB-224KB) power on status event"]
    GROUP6EN = 64,
    #[doc = "128: Enable SRAM group7 (224KB-256KB) power on status event"]
    GROUP7EN = 128,
    #[doc = "256: Enable SRAM group8 (256KB-288KB) power on status event"]
    GROUP8EN = 256,
    #[doc = "512: Enable SRAM group9 (288KB-320KB) power on status event"]
    GROUP9EN = 512,
}
...
impl<'a> SRAMEN_W<'a> {
    ...
    #[doc = "Disable SRAM power-on status event"]
    #[inline(always)]
    pub fn none(self) -> &'a mut W {
        self.variant(SRAMEN_A::NONE)
    }
    #[doc = "Enable SRAM group0 (0KB-32KB) power on status event"]
    #[inline(always)]
    pub fn group0en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP0EN)
    }
    #[doc = "Enable SRAM group1 (32KB-64KB) power on status event"]
    #[inline(always)]
    pub fn group1en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP1EN)
    }
    #[doc = "Enable SRAM group2 (64KB-96KB) power on status event"]
    #[inline(always)]
    pub fn group2en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP2EN)
    }
    #[doc = "Enable SRAM group3 (96KB-128KB) power on status event"]
    #[inline(always)]
    pub fn group3en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP3EN)
    }
    #[doc = "Enable SRAM group4 (128KB-160KB) power on status event"]
    #[inline(always)]
    pub fn group4en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP4EN)
    }
    #[doc = "Enable SRAM group5 (160KB-192KB) power on status event"]
    #[inline(always)]
    pub fn group5en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP5EN)
    }
    #[doc = "Enable SRAM group6 (192KB-224KB) power on status event"]
    #[inline(always)]
    pub fn group6en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP6EN)
    }
    #[doc = "Enable SRAM group7 (224KB-256KB) power on status event"]
    #[inline(always)]
    pub fn group7en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP7EN)
    }
    #[doc = "Enable SRAM group8 (256KB-288KB) power on status event"]
    #[inline(always)]
    pub fn group8en(self) -> &'a mut W {
        self.variant(SRAMEN_A::GROUP8EN)
    }
    #[doc = "Enable SRAM group9 (288KB-320KB) power on status event"]
    #[inline(always)]
