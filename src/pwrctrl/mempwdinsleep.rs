...
pub enum FLASH1PWDSLP_A {
    #[doc = "1: Flash1 is powered down during deepsleep"]
    EN = 1,
    #[doc = "0: Flash1 is kept powered on during deepsleep"]
    DIS = 0,
}
...
impl<'a> FLASH1PWDSLP_W<'a> {
    ...
    #[doc = "Flash1 is powered down during deepsleep"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(FLASH1PWDSLP_A::EN)
    }
    #[doc = "Flash1 is kept powered on during deepsleep"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub enum FLASH0PWDSLP_A {
    #[doc = "1: Flash0 is powered down during deepsleep"]
    EN = 1,
    #[doc = "0: Flash0 is kept powered on during deepsleep"]
    DIS = 0,
}
...
impl<'a> FLASH0PWDSLP_W<'a> {
    ...
    #[doc = "Flash0 is powered down during deepsleep"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
        self.variant(FLASH0PWDSLP_A::EN)
    }
    #[doc = "Flash0 is kept powered on during deepsleep"]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
...
pub enum SRAMPWDSLP_A {
    ...
    NONE = 0,
    #[doc = "1: SRAM GROUP0 powered down (64KB-96KB)"]
    GROUP0 = 1,
    #[doc = "2: SRAM GROUP1 powered down (96KB-128KB)"]
    GROUP1 = 2,
    #[doc = "4: SRAM GROUP2 powered down (128KB-160KB)"]
    GROUP2 = 4,
    #[doc = "8: SRAM GROUP3 powered down (160KB-192KB)"]
    GROUP3 = 8,
    #[doc = "16: SRAM GROUP4 powered down (192KB-224KB)"]
    GROUP4 = 16,
    #[doc = "32: SRAM GROUP5 powered down (224KB-256KB)"]
    GROUP5 = 32,
    #[doc = "64: SRAM GROUP6 powered down (256KB-288KB)"]
    GROUP6 = 64,
    #[doc = "128: SRAM GROUP7 powered down (288KB-320KB)"]
    GROUP7 = 128,
    #[doc = "256: SRAM GROUP8 powered down (320KB-352KB)"]
    GROUP8 = 256,
    #[doc = "512: SRAM GROUP9 powered down (352KB-384KB)"]
    GROUP9 = 512,
    #[doc = "3: Powerdown lower 64k SRAM (64KB-128KB)"]
    SRAM64K = 3,
    #[doc = "15: Powerdown lower 128k SRAM (64KB-192KB)"]
    SRAM128K = 15,
    #[doc = "1022: All SRAM banks but lower 32k powered down (96KB-384KB)."]
    ALLBUTLOWER32K = 1022,
    #[doc = "1020: All banks but lower 64k powered down."]
    ALLBUTLOWER64K = 1020,
    #[doc = "1008: All banks but lower 128k powered down."]
    ALLBUTLOWER128K = 1008,
    #[doc = "1023: All banks powered down."]
    ALL = 1023,
}
...
pub enum DTCMPWDSLP_A {
    ...
    GROUP0DTCM0 = 1,
    #[doc = "2: Group0_DTCM1 powered down in deep sleep (8KB-32KB)"]
    GROUP0DTCM1 = 2,
    #[doc = "3: Both DTCMs in group0 are powered down in deep sleep (0KB-32KB)"]
    GROUP0 = 3,
    #[doc = "6: Group1 and Group0_DTCM1 are powered down in deep sleep (8KB-64KB)"]
    ALLBUTGROUP0DTCM0 = 6,
    #[doc = "4: Group1 DTCM powered down in deep sleep (32KB-64KB)"]
    GROUP1 = 4,
    #[doc = "7: All DTCMs powered down in deep sleep (0KB-64KB)"]
    ALL = 7,
}
...
impl<'a> DTCMPWDSLP_W<'a> {
    ...
    #[doc = "Group0_DTCM1 powered down in deep sleep (8KB-32KB)"]
    #[inline(always)]
    pub fn group0dtcm1(self) -> &'a mut W {
        self.variant(DTCMPWDSLP_A::GROUP0DTCM1)
    }
    #[doc = "Both DTCMs in group0 are powered down in deep sleep (0KB-32KB)"]
    #[inline(always)]
    pub fn group0(self) -> &'a mut W {
        self.variant(DTCMPWDSLP_A::GROUP0)
    }
    #[doc = "Group1 and Group0_DTCM1 are powered down in deep sleep (8KB-64KB)"]
    #[inline(always)]
    pub fn allbutgroup0dtcm0(self) -> &'a mut W {
        self.variant(DTCMPWDSLP_A::ALLBUTGROUP0DTCM0)
    }
    #[doc = "Group1 DTCM powered down in deep sleep (32KB-64KB)"]
    #[inline(always)]
    pub fn group1(self) -> &'a mut W {
        self.variant(DTCMPWDSLP_A::GROUP1)
    }
    #[doc = "All DTCMs powered down in deep sleep (0KB-64KB)"]
    #[inline(always)]
    pub fn all(self) -> &'a mut W {
