...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FLASH1_A {
    #[doc = "1: Power up Flash1"]
    EN = 1,
    #[doc = "0: Power down Flash1"]
    DIS = 0,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FLASH0_A {
    #[doc = "1: Power up Flash0"]
    EN = 1,
    #[doc = "0: Power down Flash0"]
    DIS = 0,
}
...
pub enum SRAM_A {
    ...
    NONE = 0,
    #[doc = "1: Power ON only SRAM group0 (0KB-32KB)"]
    GROUP0 = 1,
    #[doc = "2: Power ON only SRAM group1 (32KB-64KB)"]
    GROUP1 = 2,
    #[doc = "4: Power ON only SRAM group2 (64KB-96KB)"]
    GROUP2 = 4,
    #[doc = "8: Power ON only SRAM group3 (96KB-128KB)"]
    GROUP3 = 8,
    #[doc = "16: Power ON only SRAM group4 (128KB-160KB)"]
    GROUP4 = 16,
    #[doc = "32: Power ON only SRAM group5 (160KB-192KB)"]
    GROUP5 = 32,
    #[doc = "64: Power ON only SRAM group6 (192KB-224KB)"]
    GROUP6 = 64,
    #[doc = "128: Power ON only SRAM group7 (224KB-256KB)"]
    GROUP7 = 128,
    #[doc = "256: Power ON only SRAM group8 (256KB-288KB)"]
    GROUP8 = 256,
    #[doc = "512: Power ON only SRAM group9 (288KB-320KB)"]
    GROUP9 = 512,
    #[doc = "3: Power ON only lower 64k"]
    SRAM64K = 3,
    #[doc = "15: Power ON only lower 128k"]
    SRAM128K = 15,
    #[doc = "255: Power ON only lower 256k"]
    SRAM256K = 255,
    #[doc = "1023: All SRAM banks (320K) powered ON"]
    ALL = 1023,
}
...
impl<'a> SRAM_W<'a> {
    ...
    #[doc = "Power ON only lower 256k"]
    #[inline(always)]
    pub fn sram256k(self) -> &'a mut W {
        self.variant(SRAM_A::SRAM256K)
    }
    #[doc = "All SRAM banks (320K) powered ON"]
    #[inline(always)]
...
pub enum DTCM_A {
    ...
    NONE = 0,
    #[doc = "1: Power ON only GROUP0_DTCM0"]
    GROUP0DTCM0 = 1,
    #[doc = "2: Power ON only GROUP0_DTCM1"]
    GROUP0DTCM1 = 2,
    #[doc = "3: Power ON only DTCMs in group0"]
    GROUP0 = 3,
    #[doc = "4: Power ON only DTCMs in group1"]
    GROUP1 = 4,
    #[doc = "7: Power ON all DTCMs"]
    ALL = 7,
}
