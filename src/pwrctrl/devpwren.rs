...
pub enum PWRBLEL_A {
    #[doc = "1: Power up BLE controller"]
    EN = 1,
    #[doc = "0: Power down BLE controller"]
    DIS = 0,
}
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PWRSCARD_A {
    #[doc = "1: Power up SCARD"]
    EN = 1,
    #[doc = "0: Power down SCARD"]
    DIS = 0,
}
