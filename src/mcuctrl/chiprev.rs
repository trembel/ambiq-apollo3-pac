...
#[repr(u8)]
pub enum REVMAJ_A {
    #[doc = "2: Apollo3 Blue revision B"]
    B = 2,
    #[doc = "1: Apollo3 Blue revision A"]
    A = 1,
}
...
impl<'a> REVMAJ_W<'a> {
    ...
    #[doc = "Apollo3 Blue revision B"]
    #[inline(always)]
    pub fn b(self) -> &'a mut W {
        self.variant(REVMAJ_A::B)
    }
    #[doc = "Apollo3 Blue revision A"]
    #[inline(always)]
...
#[repr(u8)]
pub enum REVMIN_A {
    #[doc = "2: Apollo3 Blue minor rev 1."]
    REV1 = 2,
    #[doc = "1: Apollo3 Blue minor rev 0.  Minor revision value, succeeding minor revisions will increment from this value."]
    REV0 = 1,
}
...
impl<'a> REVMIN_W<'a> {
    ...
    #[doc = "Apollo3 Blue minor rev 1."]
    #[inline(always)]
    pub fn rev1(self) -> &'a mut W {
        self.variant(REVMIN_A::REV1)
    }
    #[doc = "Apollo3 Blue minor rev 0. Minor revision value, succeeding minor revisions will increment from this value."]
    #[inline(always)]
