...
pub enum CQFLAGS_A {
    ...
    CMDCPL = 1024,
    #[doc = "512: IOM Buffer 1 Ready Status (from selected IOM). This status is the result of XNOR'ing the IOM0START with the incoming status from the IOM. When high, MSPI can send to the buffer."]
    IOM1READY = 512,
    #[doc = "256: IOM Buffer 0 Ready Status (from selected IOM). This status is the result of XNOR'ing the IOM0START with the incoming status from the IOM. When high, MSPI can send to the buffer."]
    IOM0READY = 256,
    ...
    SWFLAG2 = 4,
    #[doc = "2: Software flag 1. Can be used by software to start/pause operations."]
    SWFLAG1 = 2,
    #[doc = "1: Software flag 0. Can be used by software to start/pause operations."]
    SWFLAG0 = 1,
}
...
impl<'a> CQFLAGS_W<'a> {
    ...
    #[doc = "IOM Buffer 1 Ready Status (from selected IOM). This status is the result of XNOR'ing the IOM0START with the incoming status from the IOM. When high, MSPI can send to the buffer."]
    #[inline(always)]
    pub fn iom1ready(self) -> &'a mut W {
        self.variant(CQFLAGS_A::IOM1READY)
    }
    #[doc = "IOM Buffer 0 Ready Status (from selected IOM). This status is the result of XNOR'ing the IOM0START with the incoming status from the IOM. When high, MSPI can send to the buffer."]
    #[inline(always)]
    ...
    #[doc = "Software flag 1. Can be used by software to start/pause operations."]
    #[inline(always)]
    pub fn swflag1(self) -> &'a mut W {
        self.variant(CQFLAGS_A::SWFLAG1)
    }
    #[doc = "Software flag 0. Can be used by software to start/pause operations."]
    #[inline(always)]
