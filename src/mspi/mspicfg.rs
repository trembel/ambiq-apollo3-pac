...
#[repr(u8)]
pub enum CLKDIV_A {
    #[doc = "1: 48 MHz MSPI clock"]
    CLK48 = 1,
    #[doc = "2: 24 MHz MSPI clock"]
    CLK24 = 2,
    #[doc = "4: 12 MHz MSPI clock"]
    CLK12 = 4,
    #[doc = "8: 6 MHz MSPI clock"]
    CLK6 = 8,
    #[doc = "16: 3 MHz MSPI clock"]
    CLK3 = 16,
    #[doc = "32: 1.5 MHz MSPI clock"]
    CLK1_5 = 32,
}
...
impl CLKDIV_R {
    ...
    #[doc = "Checks if the value of the field is `CLK48`"]
    #[inline(always)]
...
impl<'a> CLKDIV_W<'a> {
    ...
    #[inline(always)]
    pub fn clk48(self) -> &'a mut W {
        self.variant(CLKDIV_A::CLK48)
    }
...
pub enum IOMSEL_A {
    ...
    #[doc = "5: IOM5"]
    IOM5 = 5,
    #[doc = "7: No IOM selected. Signals always zero."]
    DISABLED = 7,
}
...
impl<'a> IOMSEL_W<'a> {
    ...
    #[doc = "No IOM selected. Signals always zero."]
    #[inline(always)]
...
#[doc = "Launches TX data a half clock cycle (~10 ns) early. This should normally be programmed to zero (NORMAL).\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TXNEG_A {
...
#[doc = "Adjusts the RX capture phase to the negedge of the 48MHz internal clock (~10 ns early). For normal operation, it is expected that RXNEG will be set to 0.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXNEG_A {
...
#[doc = "Controls RX data capture phase. A setting of 0 (NORMAL) captures read data at the normal capture point relative to the internal clock launch point. However, to accommodate chip/pad/board delays, a setting of RXCAP of 1 is expected to be used to align the capture point with the return data window. This bit is used in conjunction with RXNEG to provide 4 unique capture points, all about 10 ns apart.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RXCAP_A {
...
impl R {
    ...
    #[doc = "Bit 3 - Launches TX data a half clock cycle (~10 ns) early. This should normally be programmed to zero (NORMAL)."]
    #[inline(always)]
    pub fn txneg(&self) -> TXNEG_R {
        TXNEG_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Adjusts the RX capture phase to the negedge of the 48MHz internal clock (~10 ns early). For normal operation, it is expected that RXNEG will be set to 0."]
    #[inline(always)]
