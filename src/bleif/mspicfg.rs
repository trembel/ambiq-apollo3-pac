...
#[doc = "Register MSPICFG `reset()`'s with value 0x4000_0000"]
...
#[doc = "Reader of field `MSPIRST`"]
pub type MSPIRST_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `MSPIRST`"]
...
#[doc = "Reader of field `DOUTDLY`"]
pub type DOUTDLY_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `DOUTDLY`"]
...
#[doc = "Reader of field `DINDLY`"]
pub type DINDLY_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `DINDLY`"]
...
#[doc = "Reader of field `SPILSB`"]
pub type SPILSB_R = crate::R<bool, SPILSB_A>;
impl SPILSB_R {
...
#[doc = "Write proxy for field `SPILSB`"]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RDFCPOL_A {
    #[doc = "0: SPI_STATUS signal from BLE Core high(1) creates flow control and new read spi transactions will not be started until the signal goes low.(default)"]
    NORMAL = 0,
    #[doc = "1: SPI_STATUS signal from BLE Core low(0) creates flow control and new read spi transactions will not be started until the signal goes high."]
    INVERTED = 1,
}
...
impl<'a> RDFCPOL_W<'a> {
    ...
    #[doc = "SPI_STATUS signal from BLE Core high(1) creates flow control and new read spi transactions will not be started until the signal goes low.(default)"]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(RDFCPOL_A::NORMAL)
    }
    #[doc = "SPI_STATUS signal from BLE Core low(0) creates flow control and new read spi transactions will not be started until the signal goes high."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum WTFCPOL_A {
    #[doc = "0: SPI_STATUS signal from BLE Core high(1) creates flow control and new write spi transactions will not be started until the signal goes low.(default)"]
    NORMAL = 0,
    #[doc = "1: SPI_STATUS signal from BLE Core high(1) creates low(0) control and new write spi transactions will not be started until the signal goes high."]
    INVERTED = 1,
}
...
impl<'a> WTFCPOL_W<'a> {
    ...
    #[doc = "SPI_STATUS signal from BLE Core high(1) creates flow control and new write spi transactions will not be started until the signal goes low.(default)"]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(WTFCPOL_A::NORMAL)
    }
    #[doc = "SPI_STATUS signal from BLE Core high(1) creates low(0) control and new write spi transactions will not be started until the signal goes high."]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut W {
...
pub type FULLDUP_R = crate::R<bool, bool>;
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SPHA_A {
    #[doc = "0: Sample on the leading (first) clock edge, rising or falling dependant on the value of SPOL"]
    SAMPLE_LEADING_EDGE = 0,
    #[doc = "1: Sample on the trailing (second) clock edge, rising of falling dependant on the value of SPOL"]
...
impl<'a> SPHA_W<'a> {
    ...
    #[doc = "Sample on the leading (first) clock edge, rising or falling dependant on the value of SPOL"]
    #[inline(always)]
    pub fn sample_leading_edge(self) -> &'a mut W {
        self.variant(SPHA_A::SAMPLE_LEADING_EDGE)
    }
    #[doc = "Sample on the trailing (second) clock edge, rising of falling dependant on the value of SPOL"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SPOL_A {
    #[doc = "0: The initial value of the clock is 0."]
    CLK_BASE_0 = 0,
    #[doc = "1: The initial value of the clock is 1."]
    CLK_BASE_1 = 1,
}
...
impl<'a> SPOL_W<'a> {
    ...
    #[doc = "The initial value of the clock is 0."]
    #[inline(always)]
    pub fn clk_base_0(self) -> &'a mut W {
        self.variant(SPOL_A::CLK_BASE_0)
    }
    #[doc = "The initial value of the clock is 1."]
    #[inline(always)]
