...
pub enum SPIISOCTL_A {
    #[doc = "3: SPI signals from BLE Core to/from MCU Core are isolated."]
    ON = 3,
    #[doc = "2: SPI signals from BLE Core to/from MCU Core are not isolated."]
    OFF = 2,
    #[doc = "0: SPI signals from BLE Core to/from MCU Core are automatically isolated by the logic"]
    AUTO = 0,
}
...
impl<'a> SPIISOCTL_W<'a> {
    ...
    #[doc = "SPI signals from BLE Core to/from MCU Core are isolated."]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(SPIISOCTL_A::ON)
    }
    #[doc = "SPI signals from BLE Core to/from MCU Core are not isolated."]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(SPIISOCTL_A::OFF)
    }
    #[doc = "SPI signals from BLE Core to/from MCU Core are automatically isolated by the logic"]
    #[inline(always)]
...
pub enum PWRISOCTL_A {
    #[doc = "3: BLEH power signal isolation to on (isolated)."]
    ON = 3,
    #[doc = "2: BLEH power signal isolation to off (not isolated)."]
    OFF = 2,
    #[doc = "0: BLEH Power signal isolation is controlled automatically through the interface logic"]
    AUTO = 0,
}
...
impl<'a> PWRISOCTL_W<'a> {
    ...
    #[doc = "BLEH power signal isolation to on (isolated)."]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(PWRISOCTL_A::ON)
    }
    #[doc = "BLEH power signal isolation to off (not isolated)."]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(PWRISOCTL_A::OFF)
    }
    #[doc = "BLEH Power signal isolation is controlled automatically through the interface logic"]
    #[inline(always)]
    pub fn auto(self) -> &'a mut W {
...
pub enum BLEHREQCTL_A {
    #[doc = "3: BLEH Power-on reg signal is set to on (1)."]
    ON = 3,
    #[doc = "2: BLEH Power-on signal is set to off (0)."]
    OFF = 2,
    #[doc = "0: BLEH Power-on signal is controlled by the PWRSM logic and automatically controlled"]
    AUTO = 0,
}
...
impl<'a> BLEHREQCTL_W<'a> {
    ...
    #[doc = "BLEH Power-on reg signal is set to on (1)."]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(BLEHREQCTL_A::ON)
    }
    #[doc = "BLEH Power-on signal is set to off (0)."]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(BLEHREQCTL_A::OFF)
    }
    #[doc = "BLEH Power-on signal is controlled by the PWRSM logic and automatically controlled"]
    #[inline(always)]
    pub fn auto(self) -> &'a mut W {
...
pub enum DCDCFLGCTL_A {
    #[doc = "3: DCDC Flag signal is set to on (1)."]
    ON = 3,
    #[doc = "2: DCDC Flag signal is set to off (0)."]
    OFF = 2,
    #[doc = "0: DCDC Flag signal is controlled by the PWRSM logic and automatically controlled"]
    AUTO = 0,
}
...
impl<'a> DCDCFLGCTL_W<'a> {
    ...
    #[doc = "DCDC Flag signal is set to on (1)."]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(DCDCFLGCTL_A::ON)
    }
    #[doc = "DCDC Flag signal is set to off (0)."]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(DCDCFLGCTL_A::OFF)
    }
    #[doc = "DCDC Flag signal is controlled by the PWRSM logic and automatically controlled"]
    #[inline(always)]
    pub fn auto(self) -> &'a mut W {
...
pub enum WAKEUPCTL_A {
    #[doc = "3: Wake signal is set to on (1)."]
    ON = 3,
    #[doc = "2: Wake signal is set to off (0)."]
    OFF = 2,
    #[doc = "0: Wake signal is controlled by the PWRSM logic and automatically controlled"]
    AUTO = 0,
}
...
impl<'a> WAKEUPCTL_W<'a> {
    ...
    #[doc = "Wake signal is set to on (1)."]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(WAKEUPCTL_A::ON)
    }
    #[doc = "Wake signal is set to off (0)."]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(WAKEUPCTL_A::OFF)
    }
    #[doc = "Wake signal is controlled by the PWRSM logic and automatically controlled"]
    #[inline(always)]
    pub fn auto(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum BLERSTN_A {
    #[doc = "1: The reset signal is active (0)"]
    ACTIVE = 1,
    #[doc = "0: The reset signal is inactive (1)"]
    INACTIVE = 0,
}
...
impl<'a> BLERSTN_W<'a> {
    ...
    #[doc = "The reset signal is active (0)"]
    #[inline(always)]
    pub fn active(self) -> &'a mut W {
        self.variant(BLERSTN_A::ACTIVE)
    }
    #[doc = "The reset signal is inactive (1)"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PWRSMEN_A {
    #[doc = "1: Internal power state machine is enabled and will sequence the BLEH power domain as indicated in the design document. Overrides for the power signals are not enabled."]
    ON = 1,
    #[doc = "0: Internal power state machine is disabled and will not sequence the BLEH power domain. The values of the overrides will be used to drive the output sequencing signals"]
    OFF = 0,
}
...
impl<'a> PWRSMEN_W<'a> {
    ...
    #[doc = "Internal power state machine is enabled and will sequence the BLEH power domain as indicated in the design document. Overrides for the power signals are not enabled."]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(PWRSMEN_A::ON)
    }
    #[doc = "Internal power state machine is disabled and will not sequence the BLEH power domain. The values of the overrides will be used to drive the output sequencing signals"]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
