...
pub enum PWRST_A {
    ...
    OFF = 0,
    #[doc = "1: Initialization state. BLEH not powered"]
    INIT = 1,
    #[doc = "2: Waiting for the powerup of the BLEH"]
    PWRON = 2,
    #[doc = "3: The BLE Core is powered and active"]
    ACTIVE = 3,
    #[doc = "6: The BLE Core has entered sleep mode and the power request is inactive"]
    SLEEP = 6,
    #[doc = "4: The BLE Core is in shutdown mode"]
    SHUTDOWN = 4,
}
...
impl<'a> PWRST_W<'a> {
    ...
    #[doc = "Initialization state. BLEH not powered"]
    #[inline(always)]
    pub fn init(self) -> &'a mut W {
        self.variant(PWRST_A::INIT)
    }
    #[doc = "Waiting for the powerup of the BLEH"]
    #[inline(always)]
    pub fn pwron(self) -> &'a mut W {
        self.variant(PWRST_A::PWRON)
    }
    #[doc = "The BLE Core is powered and active"]
    #[inline(always)]
    pub fn active(self) -> &'a mut W {
        self.variant(PWRST_A::ACTIVE)
    }
    #[doc = "The BLE Core has entered sleep mode and the power request is inactive"]
    #[inline(always)]
    pub fn sleep(self) -> &'a mut W {
        self.variant(PWRST_A::SLEEP)
    }
    #[doc = "The BLE Core is in shutdown mode"]
    #[inline(always)]
