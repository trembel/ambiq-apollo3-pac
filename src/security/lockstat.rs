...
#[repr(u32)]
pub enum STATUS_A {
    #[doc = "1: Customer Key is unlocked (access is granted to top half of info0)"]
    CUSTOMER_KEY = 1,
    #[doc = "0: No resources are unlocked"]
    NONE = 0,
}
...
impl<'a> STATUS_W<'a> {
    ...
    #[doc = "Customer Key is unlocked (access is granted to top half of info0)"]
    #[inline(always)]
    pub fn customer_key(self) -> &'a mut W {
        self.variant(STATUS_A::CUSTOMER_KEY)
    }
    #[doc = "No resources are unlocked"]
    #[inline(always)]
