...
pub struct RegisterBlock {
    ...
    #[doc = "0x118 - ADC Trims"]
    pub adctrim: ADCTRIM,
    #[doc = "0x11c - ADC Reference Keeper and Comparator Control"]
    ...
    #[doc = "0x354 - SIMO Buck Control Reg 2"]
    pub simobuck2: SIMOBUCK2,
    #[doc = "0x358 - SIMO Buck Control Reg 3"]
    pub simobuck3: SIMOBUCK3,
    #[doc = "0x35c - SIMO Buck Control Reg 4"]
    pub simobuck4: SIMOBUCK4,
    _reserved37: [u8; 8usize],
    #[doc = "0x368 - BLEBUCK2 Control Reg"]
    pub blebuck2: BLEBUCK2,
    _reserved38: [u8; 52usize],
...
#[doc = "Key Register to enable the use of external clock selects via the EXTCLKSEL reg"]
pub mod kextclksel;
#[doc = "SIMO Buck Control Reg 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [simobuck2](simobuck2) module"]
pub type SIMOBUCK2 = crate::Reg<u32, _SIMOBUCK2>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SIMOBUCK2;
#[doc = "`read()` method returns [simobuck2::R](simobuck2::R) reader structure"]
impl crate::Readable for SIMOBUCK2 {}
#[doc = "`write(|w| ..)` method takes [simobuck2::W](simobuck2::W) writer structure"]
impl crate::Writable for SIMOBUCK2 {}
#[doc = "SIMO Buck Control Reg 2"]
pub mod simobuck2;
#[doc = "SIMO Buck Control Reg 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [simobuck3](simobuck3) module"]
pub type SIMOBUCK3 = crate::Reg<u32, _SIMOBUCK3>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SIMOBUCK3;
#[doc = "`read()` method returns [simobuck3::R](simobuck3::R) reader structure"]
impl crate::Readable for SIMOBUCK3 {}
#[doc = "`write(|w| ..)` method takes [simobuck3::W](simobuck3::W) writer structure"]
impl crate::Writable for SIMOBUCK3 {}
#[doc = "SIMO Buck Control Reg 3"]
pub mod simobuck3;
#[doc = "SIMO Buck Control Reg 4\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [simobuck4](simobuck4) module"]
