...
#[repr(u8)]
pub enum CLKSEL_A {
    #[doc = "0: Off mode. The HFRC or HFRC_DIV2 clock must be selected for the ADC to function. The ADC controller automatically shuts off the clock in it's low power modes.  When setting ADCEN to '0', the CLKSEL should remain set to one of the two clock selects for proper power down sequencing."]
    OFF = 0,
    #[doc = "1: HFRC Core Clock divided by (CORESEL+1)"]
    HFRC = 1,
    #[doc = "2: HFRC Core Clock / 2 further divided by (CORESEL+1)"]
    HFRC_DIV2 = 2,
}
...
impl<'a> CLKSEL_W<'a> {
    ...
    #[doc = "Off mode. The HFRC or HFRC_DIV2 clock must be selected for the ADC to function. The ADC controller automatically shuts off the clock in it's low power modes. When setting ADCEN to '0', the CLKSEL should remain set to one of the two clock selects for proper power down sequencing."]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(CLKSEL_A::OFF)
    }
    #[doc = "HFRC Core Clock divided by (CORESEL+1)"]
    #[inline(always)]
    pub fn hfrc(self) -> &'a mut W {
        self.variant(CLKSEL_A::HFRC)
    }
    #[doc = "HFRC Core Clock / 2 further divided by (CORESEL+1)"]
    #[inline(always)]
...
#[repr(u8)]
pub enum REFSEL_A {
    #[doc = "0: Internal 2.0V Bandgap Reference Voltage"]
    INT2P0 = 0,
    #[doc = "1: Internal 1.5V Bandgap Reference Voltage"]
    INT1P5 = 1,
    #[doc = "2: Off Chip 2.0V Reference"]
    EXT2P0 = 2,
    #[doc = "3: Off Chip 1.5V Reference"]
    EXT1P5 = 3,
}
