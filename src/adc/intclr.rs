...
pub type DERR_R = crate::R<bool, DERR_A>;
impl DERR_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, DERR_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(DERR_A::DMAERROR),
            i => Res(i),
        }
    }
...
pub type DCMP_R = crate::R<bool, DCMP_A>;
impl DCMP_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, DCMP_A> {
        use crate::Variant::*;
        match self.bits {
            true => Val(DCMP_A::DMACOMPLETE),
            i => Res(i),
        }
    }
