...
pub enum CTLINK4_A {
    #[doc = "0: Use A4/B4 timers as two independent 16-bit timers (default)."]
    TWO_16BIT_TIMERS = 0,
    #[doc = "1: Link A4/B4 timers into a single 32-bit timer."]
    _32BIT_TIMER = 1,
}
...
impl<'a> CTLINK4_W<'a> {
    ...
    #[doc = "Use A4/B4 timers as two independent 16-bit timers (default)."]
    #[inline(always)]
    pub fn two_16bit_timers(self) -> &'a mut W {
        self.variant(CTLINK4_A::TWO_16BIT_TIMERS)
    }
    #[doc = "Link A4/B4 timers into a single 32-bit timer."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB4POL_A {
    #[doc = "0: The polarity of the TMRPINB4 pin is the same as the timer output."]
    NORMAL = 0,
    #[doc = "1: The polarity of the TMRPINB4 pin is the inverse of the timer output."]
    INVERTED = 1,
}
...
impl<'a> TMRB4POL_W<'a> {
    ...
    #[doc = "The polarity of the TMRPINB4 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(TMRB4POL_A::NORMAL)
    }
    #[doc = "The polarity of the TMRPINB4 pin is the inverse of the timer output."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB4CLR_A {
    #[doc = "0: Allow counter/timer B4 to run"]
    RUN = 0,
    #[doc = "1: Holds counter/timer B4 at 0x0000."]
    CLEAR = 1,
}
...
impl<'a> TMRB4CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer B4 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
        self.variant(TMRB4CLR_A::RUN)
    }
    #[doc = "Holds counter/timer B4 at 0x0000."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB4IE1_A {
    #[doc = "0: Disable counter/timer B4 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B4 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRB4IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer B4 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB4IE1_A::DIS)
    }
    #[doc = "Enable counter/timer B4 to generate an interrupt based on COMPR1."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB4IE0_A {
    #[doc = "0: Disable counter/timer B4 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B4 to generate an interrupt based on COMPR0"]
    EN = 1,
}
...
impl<'a> TMRB4IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer B4 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB4IE0_A::DIS)
    }
    #[doc = "Enable counter/timer B4 to generate an interrupt based on COMPR0"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[repr(u8)]
pub enum TMRB4FN_A {
    #[doc = "0: Single count (output toggles and sticks).  Count to CMPR0B4, stop."]
    SINGLECOUNT = 0,
    #[doc = "1: Repeated count (periodic 1-clock-cycle-wide pulses).  Count to CMPR0B4, restart."]
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0B4, assert, count to CMPR1B4, deassert, stop."]
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continously.  Count to CMPR0B4, assert, count to CMPR1B4, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB4FN_W<'a> {
    ...
    #[doc = "Single count (output toggles and sticks). Count to CMPR0B4, stop."]
    #[inline(always)]
    pub fn singlecount(self) -> &'a mut W {
        self.variant(TMRB4FN_A::SINGLECOUNT)
    }
    #[doc = "Repeated count (periodic 1-clock-cycle-wide pulses). Count to CMPR0B4, restart."]
    #[inline(always)]
    pub fn repeatedcount(self) -> &'a mut W {
        self.variant(TMRB4FN_A::REPEATEDCOUNT)
    }
    #[doc = "Pulse once (aka one-shot). Count to CMPR0B4, assert, count to CMPR1B4, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
        self.variant(TMRB4FN_A::PULSE_ONCE)
    }
    #[doc = "Pulse continously. Count to CMPR0B4, assert, count to CMPR1B4, deassert, restart."]
    #[inline(always)]
...
pub enum TMRB4CLK_A {
    ...
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERA4 OUT."]
    CTMRA4 = 20,
    #[doc = "21: Clock source is CTIMERA1 OUT."]
    CTMRA1 = 21,
    #[doc = "22: Clock source is CTIMERB1 OUT."]
    CTMRB1 = 22,
    #[doc = "23: Clock source is CTIMERA5 OUT."]
    CTMRA5 = 23,
    #[doc = "24: Clock source is CTIMERB5 OUT."]
    CTMRB5 = 24,
...
impl<'a> TMRB4CLK_W<'a> {
    ...
    #[doc = "Clock source is CTIMERA4 OUT."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB4EN_A {
    #[doc = "0: Counter/Timer B4 Disable."]
    DIS = 0,
    #[doc = "1: Counter/Timer B4 Enable."]
    EN = 1,
}
...
impl<'a> TMRB4EN_W<'a> {
    ...
    #[doc = "Counter/Timer B4 Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB4EN_A::DIS)
    }
    #[doc = "Counter/Timer B4 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA4POL_A {
    #[doc = "0: The polarity of the TMRPINA4 pin is the same as the timer output."]
    NORMAL = 0,
    #[doc = "1: The polarity of the TMRPINA4 pin is the inverse of the timer output."]
    INVERTED = 1,
}
...
impl<'a> TMRA4POL_W<'a> {
    ...
    #[doc = "The polarity of the TMRPINA4 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(TMRA4POL_A::NORMAL)
    }
    #[doc = "The polarity of the TMRPINA4 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA4CLR_A {
    #[doc = "0: Allow counter/timer A4 to run"]
    RUN = 0,
    #[doc = "1: Holds counter/timer A4 at 0x0000."]
    CLEAR = 1,
}
...
impl<'a> TMRA4CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer A4 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
        self.variant(TMRA4CLR_A::RUN)
    }
    #[doc = "Holds counter/timer A4 at 0x0000."]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA4IE1_A {
    #[doc = "0: Disable counter/timer A4 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A4 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRA4IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer A4 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA4IE1_A::DIS)
    }
    #[doc = "Enable counter/timer A4 to generate an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA4IE0_A {
    #[doc = "0: Disable counter/timer A4 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A4 to generate an interrupt based on COMPR0."]
    EN = 1,
}
...
impl<'a> TMRA4IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer A4 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA4IE0_A::DIS)
    }
    #[doc = "Enable counter/timer A4 to generate an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[repr(u8)]
pub enum TMRA4FN_A {
    #[doc = "0: Single count (output toggles and sticks).  Count to CMPR0A4, stop."]
    SINGLECOUNT = 0,
    #[doc = "1: Repeated count (periodic 1-clock-cycle-wide pulses).  Count to CMPR0A4, restart."]
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0A4, assert, count to CMPR1A4, deassert, stop."]
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continously.  Count to CMPR0A4, assert, count to CMPR1A4, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA4FN_W<'a> {
    ...
    #[doc = "Single count (output toggles and sticks). Count to CMPR0A4, stop."]
    #[inline(always)]
    pub fn singlecount(self) -> &'a mut W {
        self.variant(TMRA4FN_A::SINGLECOUNT)
    }
    #[doc = "Repeated count (periodic 1-clock-cycle-wide pulses). Count to CMPR0A4, restart."]
    #[inline(always)]
    pub fn repeatedcount(self) -> &'a mut W {
        self.variant(TMRA4FN_A::REPEATEDCOUNT)
    }
    #[doc = "Pulse once (aka one-shot). Count to CMPR0A4, assert, count to CMPR1A4, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
        self.variant(TMRA4FN_A::PULSE_ONCE)
    }
    #[doc = "Pulse continously. Count to CMPR0A4, assert, count to CMPR1A4, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
...
pub enum TMRA4CLK_A {
    ...
    #[doc = "18: Clock source is XT / 32"]
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERB4 OUT."]
    CTMRB4 = 20,
    #[doc = "21: Clock source is CTIMERA1 OUT."]
    CTMRA1 = 21,
    #[doc = "22: Clock source is CTIMERB1 OUT."]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA4EN_A {
    #[doc = "0: Counter/Timer A4 Disable."]
    DIS = 0,
    #[doc = "1: Counter/Timer A4 Enable."]
    EN = 1,
}
...
impl<'a> TMRA4EN_W<'a> {
    ...
    #[doc = "Counter/Timer A4 Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA4EN_A::DIS)
    }
    #[doc = "Counter/Timer A4 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
