...
pub enum CTLINK6_A {
    #[doc = "0: Use A6/B6 timers as two independent 16-bit timers (default)."]
    TWO_16BIT_TIMERS = 0,
    #[doc = "1: Link A6/B6 timers into a single 32-bit timer."]
    _32BIT_TIMER = 1,
}
...
impl<'a> CTLINK6_W<'a> {
    ...
    #[doc = "Use A6/B6 timers as two independent 16-bit timers (default)."]
    #[inline(always)]
    pub fn two_16bit_timers(self) -> &'a mut W {
        self.variant(CTLINK6_A::TWO_16BIT_TIMERS)
    }
    #[doc = "Link A6/B6 timers into a single 32-bit timer."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB6POL_A {
    #[doc = "0: The polarity of the TMRPINB6 pin is the same as the timer output."]
    NORMAL = 0,
    #[doc = "1: The polarity of the TMRPINB6 pin is the inverse of the timer output."]
    INVERTED = 1,
}
...
impl<'a> TMRB6POL_W<'a> {
    ...
    #[doc = "The polarity of the TMRPINB6 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(TMRB6POL_A::NORMAL)
    }
    #[doc = "The polarity of the TMRPINB6 pin is the inverse of the timer output."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB6CLR_A {
    #[doc = "0: Allow counter/timer B6 to run"]
    RUN = 0,
    #[doc = "1: Holds counter/timer B6 at 0x0000."]
    CLEAR = 1,
}
...
impl<'a> TMRB6CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer B6 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
        self.variant(TMRB6CLR_A::RUN)
    }
    #[doc = "Holds counter/timer B6 at 0x0000."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB6IE1_A {
    #[doc = "0: Disable counter/timer B6 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B6 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRB6IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer B6 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB6IE1_A::DIS)
    }
    #[doc = "Enable counter/timer B6 to generate an interrupt based on COMPR1."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB6IE0_A {
    #[doc = "0: Disable counter/timer B6 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B6 to generate an interrupt based on COMPR0"]
    EN = 1,
}
...
impl<'a> TMRB6IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer B6 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB6IE0_A::DIS)
    }
    #[doc = "Enable counter/timer B6 to generate an interrupt based on COMPR0"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[repr(u8)]
pub enum TMRB6FN_A {
    #[doc = "0: Single count (output toggles and sticks).  Count to CMPR0B6, stop."]
    SINGLECOUNT = 0,
    #[doc = "1: Repeated count (periodic 1-clock-cycle-wide pulses).  Count to CMPR0B6, restart."]
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0B6, assert, count to CMPR1B6, deassert, stop."]
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continously.  Count to CMPR0B6, assert, count to CMPR1B6, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB6FN_W<'a> {
    ...
    #[doc = "Single count (output toggles and sticks). Count to CMPR0B6, stop."]
    #[inline(always)]
    pub fn singlecount(self) -> &'a mut W {
        self.variant(TMRB6FN_A::SINGLECOUNT)
    }
    #[doc = "Repeated count (periodic 1-clock-cycle-wide pulses). Count to CMPR0B6, restart."]
    #[inline(always)]
    pub fn repeatedcount(self) -> &'a mut W {
        self.variant(TMRB6FN_A::REPEATEDCOUNT)
    }
    #[doc = "Pulse once (aka one-shot). Count to CMPR0B6, assert, count to CMPR1B6, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
        self.variant(TMRB6FN_A::PULSE_ONCE)
    }
    #[doc = "Pulse continously. Count to CMPR0B6, assert, count to CMPR1B6, deassert, restart."]
    #[inline(always)]
...
pub enum TMRB6CLK_A {
    ...
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERA6 OUT."]
    CTMRA6 = 20,
    #[doc = "21: Clock source is CTIMERA3 OUT."]
    CTMRA3 = 21,
    #[doc = "22: Clock source is CTIMERB3 OUT."]
    CTMRB3 = 22,
    #[doc = "23: Clock source is CTIMERA7 OUT."]
    CTMRA7 = 23,
    #[doc = "24: Clock source is CTIMERB7 OUT."]
    CTMRB7 = 24,
    #[doc = "25: Clock source is CTIMERB0 OUT."]
    CTMRB0 = 25,
    #[doc = "26: Clock source is CTIMERB1 OUT."]
    CTMRB1 = 26,
    #[doc = "27: Clock source is CTIMERB2 OUT."]
    CTMRB2 = 27,
    #[doc = "28: Clock source is CTIMERB4 OUT."]
    CTMRB4 = 28,
...
impl<'a> TMRB6CLK_W<'a> {
    ...
    #[doc = "Clock source is CTIMERA6 OUT."]
    #[inline(always)]
    pub fn ctmra6(self) -> &'a mut W {
        self.variant(TMRB6CLK_A::CTMRA6)
    }
    #[doc = "Clock source is CTIMERA3 OUT."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB6EN_A {
    #[doc = "0: Counter/Timer B6 Disable."]
    DIS = 0,
    #[doc = "1: Counter/Timer B6 Enable."]
    EN = 1,
}
...
impl<'a> TMRB6EN_W<'a> {
    ...
    #[doc = "Counter/Timer B6 Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB6EN_A::DIS)
    }
    #[doc = "Counter/Timer B6 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA6POL_A {
    #[doc = "0: The polarity of the TMRPINA6 pin is the same as the timer output."]
    NORMAL = 0,
    #[doc = "1: The polarity of the TMRPINA6 pin is the inverse of the timer output."]
    INVERTED = 1,
}
...
impl<'a> TMRA6POL_W<'a> {
    ...
    #[doc = "The polarity of the TMRPINA6 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(TMRA6POL_A::NORMAL)
    }
    #[doc = "The polarity of the TMRPINA6 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA6CLR_A {
    #[doc = "0: Allow counter/timer A6 to run"]
    RUN = 0,
    #[doc = "1: Holds counter/timer A6 at 0x0000."]
    CLEAR = 1,
}
...
impl<'a> TMRA6CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer A6 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
        self.variant(TMRA6CLR_A::RUN)
    }
    #[doc = "Holds counter/timer A6 at 0x0000."]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA6IE1_A {
    #[doc = "0: Disable counter/timer A6 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A6 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRA6IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer A6 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA6IE1_A::DIS)
    }
    #[doc = "Enable counter/timer A6 to generate an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA6IE0_A {
    #[doc = "0: Disable counter/timer A6 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A6 to generate an interrupt based on COMPR0."]
    EN = 1,
}
...
impl<'a> TMRA6IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer A6 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA6IE0_A::DIS)
    }
    #[doc = "Enable counter/timer A6 to generate an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[repr(u8)]
pub enum TMRA6FN_A {
    #[doc = "0: Single count (output toggles and sticks).  Count to CMPR0A6, stop."]
    SINGLECOUNT = 0,
    #[doc = "1: Repeated count (periodic 1-clock-cycle-wide pulses).  Count to CMPR0A6, restart."]
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0A6, assert, count to CMPR1A6, deassert, stop."]
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continously.  Count to CMPR0A6, assert, count to CMPR1A6, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA6FN_W<'a> {
    ...
    #[doc = "Single count (output toggles and sticks). Count to CMPR0A6, stop."]
    #[inline(always)]
    pub fn singlecount(self) -> &'a mut W {
        self.variant(TMRA6FN_A::SINGLECOUNT)
    }
    #[doc = "Repeated count (periodic 1-clock-cycle-wide pulses). Count to CMPR0A6, restart."]
    #[inline(always)]
    pub fn repeatedcount(self) -> &'a mut W {
        self.variant(TMRA6FN_A::REPEATEDCOUNT)
    }
    #[doc = "Pulse once (aka one-shot). Count to CMPR0A6, assert, count to CMPR1A6, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
        self.variant(TMRA6FN_A::PULSE_ONCE)
    }
    #[doc = "Pulse continously. Count to CMPR0A6, assert, count to CMPR1A6, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
...
pub enum TMRA6CLK_A {
    ...
    #[doc = "18: Clock source is XT / 32"]
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERB6 OUT."]
    CTMRB6 = 20,
    #[doc = "21: Clock source is CTIMERA3 OUT."]
    CTMRA3 = 21,
    #[doc = "22: Clock source is CTIMERB3 OUT."]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA6EN_A {
    #[doc = "0: Counter/Timer A6 Disable."]
    DIS = 0,
    #[doc = "1: Counter/Timer A6 Enable."]
    EN = 1,
}
...
impl<'a> TMRA6EN_W<'a> {
    ...
    #[doc = "Counter/Timer A6 Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA6EN_A::DIS)
    }
    #[doc = "Counter/Timer A6 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
