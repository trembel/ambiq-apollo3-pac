...
pub enum CTLINK5_A {
    #[doc = "0: Use A5/B5 timers as two independent 16-bit timers (default)."]
    TWO_16BIT_TIMERS = 0,
    #[doc = "1: Link A5/B5 timers into a single 32-bit timer."]
    _32BIT_TIMER = 1,
}
...
impl<'a> CTLINK5_W<'a> {
    ...
    #[doc = "Use A5/B5 timers as two independent 16-bit timers (default)."]
    #[inline(always)]
    pub fn two_16bit_timers(self) -> &'a mut W {
        self.variant(CTLINK5_A::TWO_16BIT_TIMERS)
    }
    #[doc = "Link A5/B5 timers into a single 32-bit timer."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB5POL_A {
    #[doc = "0: The polarity of the TMRPINB5 pin is the same as the timer output."]
    NORMAL = 0,
    #[doc = "1: The polarity of the TMRPINB5 pin is the inverse of the timer output."]
    INVERTED = 1,
}
...
impl<'a> TMRB5POL_W<'a> {
    ...
    #[doc = "The polarity of the TMRPINB5 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(TMRB5POL_A::NORMAL)
    }
    #[doc = "The polarity of the TMRPINB5 pin is the inverse of the timer output."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB5CLR_A {
    #[doc = "0: Allow counter/timer B5 to run"]
    RUN = 0,
    #[doc = "1: Holds counter/timer B5 at 0x0000."]
    CLEAR = 1,
}
...
impl<'a> TMRB5CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer B5 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
        self.variant(TMRB5CLR_A::RUN)
    }
    #[doc = "Holds counter/timer B5 at 0x0000."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB5IE1_A {
    #[doc = "0: Disable counter/timer B5 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B5 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRB5IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer B5 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB5IE1_A::DIS)
    }
    #[doc = "Enable counter/timer B5 to generate an interrupt based on COMPR1."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB5IE0_A {
    #[doc = "0: Disable counter/timer B5 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B5 to generate an interrupt based on COMPR0"]
    EN = 1,
}
...
impl<'a> TMRB5IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer B5 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB5IE0_A::DIS)
    }
    #[doc = "Enable counter/timer B5 to generate an interrupt based on COMPR0"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[repr(u8)]
pub enum TMRB5FN_A {
    #[doc = "0: Single count (output toggles and sticks).  Count to CMPR0B5, stop."]
    SINGLECOUNT = 0,
    #[doc = "1: Repeated count (periodic 1-clock-cycle-wide pulses).  Count to CMPR0B5, restart."]
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0B5, assert, count to CMPR1B5, deassert, stop."]
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continously.  Count to CMPR0B5, assert, count to CMPR1B5, deassert, restart."]
    PULSE_CONT = 3,
...
impl<'a> TMRB5FN_W<'a> {
    ...
    #[doc = "Single count (output toggles and sticks). Count to CMPR0B5, stop."]
    #[inline(always)]
    pub fn singlecount(self) -> &'a mut W {
        self.variant(TMRB5FN_A::SINGLECOUNT)
    }
    #[doc = "Repeated count (periodic 1-clock-cycle-wide pulses). Count to CMPR0B5, restart."]
    #[inline(always)]
    pub fn repeatedcount(self) -> &'a mut W {
        self.variant(TMRB5FN_A::REPEATEDCOUNT)
    }
    #[doc = "Pulse once (aka one-shot). Count to CMPR0B5, assert, count to CMPR1B5, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
        self.variant(TMRB5FN_A::PULSE_ONCE)
    }
    #[doc = "Pulse continously. Count to CMPR0B5, assert, count to CMPR1B5, deassert, restart."]
    #[inline(always)]
...
pub enum TMRB5CLK_A {
    ...
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERA5 OUT."]
    CTMRA5 = 20,
    #[doc = "21: Clock source is CTIMERA0 OUT."]
    CTMRA0 = 21,
    #[doc = "22: Clock source is CTIMERB0 OUT."]
    CTMRB0 = 22,
    #[doc = "23: Clock source is CTIMERA6 OUT."]
    CTMRA6 = 23,
    #[doc = "24: Clock source is CTIMERB6 OUT."]
    CTMRB6 = 24,
    #[doc = "25: Clock source is CTIMERB1 OUT."]
    CTMRB1 = 25,
    #[doc = "26: Clock source is CTIMERB2 OUT."]
    CTMRB2 = 26,
    #[doc = "27: Clock source is CTIMERB3 OUT."]
    CTMRB3 = 27,
...
impl<'a> TMRB5CLK_W<'a> {
    ...
    #[doc = "Clock source is CTIMERA5 OUT."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB5EN_A {
    #[doc = "0: Counter/Timer B5 Disable."]
    DIS = 0,
    #[doc = "1: Counter/Timer B5 Enable."]
    EN = 1,
}
...
impl<'a> TMRB5EN_W<'a> {
    ...
    #[doc = "Counter/Timer B5 Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB5EN_A::DIS)
    }
    #[doc = "Counter/Timer B5 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA5POL_A {
    #[doc = "0: The polarity of the TMRPINA5 pin is the same as the timer output."]
    NORMAL = 0,
    #[doc = "1: The polarity of the TMRPINA5 pin is the inverse of the timer output."]
    INVERTED = 1,
}
...
impl<'a> TMRA5POL_W<'a> {
    ...
    #[doc = "The polarity of the TMRPINA5 pin is the same as the timer output."]
    #[inline(always)]
    pub fn normal(self) -> &'a mut W {
        self.variant(TMRA5POL_A::NORMAL)
    }
    #[doc = "The polarity of the TMRPINA5 pin is the inverse of the timer output."]
    #[inline(always)]
    pub fn inverted(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA5CLR_A {
    #[doc = "0: Allow counter/timer A5 to run"]
    RUN = 0,
    #[doc = "1: Holds counter/timer A5 at 0x0000."]
    CLEAR = 1,
}
...
impl<'a> TMRA5CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer A5 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
        self.variant(TMRA5CLR_A::RUN)
    }
    #[doc = "Holds counter/timer A5 at 0x0000."]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA5IE1_A {
    #[doc = "0: Disable counter/timer A5 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A5 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRA5IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer A5 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA5IE1_A::DIS)
    }
    #[doc = "Enable counter/timer A5 to generate an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA5IE0_A {
    #[doc = "0: Disable counter/timer A5 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A5 to generate an interrupt based on COMPR0."]
    EN = 1,
}
...
impl<'a> TMRA5IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer A5 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA5IE0_A::DIS)
    }
    #[doc = "Enable counter/timer A5 to generate an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[repr(u8)]
pub enum TMRA5FN_A {
    #[doc = "0: Single count (output toggles and sticks).  Count to CMPR0A5, stop."]
    SINGLECOUNT = 0,
    #[doc = "1: Repeated count (periodic 1-clock-cycle-wide pulses).  Count to CMPR0A5, restart."]
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0A5, assert, count to CMPR1A5, deassert, stop."]
    PULSE_ONCE = 2,
    #[doc = "3: Pulse continously.  Count to CMPR0A5, assert, count to CMPR1A5, deassert, restart."]
    PULSE_CONT = 3,
    #[doc = "4: Single pattern."]
    SINGLEPATTERN = 4,
    #[doc = "5: Repeated pattern."]
...
impl<'a> TMRA5FN_W<'a> {
    ...
    #[doc = "Single count (output toggles and sticks). Count to CMPR0A5, stop."]
    #[inline(always)]
    pub fn singlecount(self) -> &'a mut W {
        self.variant(TMRA5FN_A::SINGLECOUNT)
    }
    #[doc = "Repeated count (periodic 1-clock-cycle-wide pulses). Count to CMPR0A5, restart."]
    #[inline(always)]
    pub fn repeatedcount(self) -> &'a mut W {
        self.variant(TMRA5FN_A::REPEATEDCOUNT)
    }
    #[doc = "Pulse once (aka one-shot). Count to CMPR0A5, assert, count to CMPR1A5, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
        self.variant(TMRA5FN_A::PULSE_ONCE)
    }
    #[doc = "Pulse continously. Count to CMPR0A5, assert, count to CMPR1A5, deassert, restart."]
    #[inline(always)]
    pub fn pulse_cont(self) -> &'a mut W {
...
pub enum TMRA5CLK_A {
    ...
    #[doc = "18: Clock source is XT / 32"]
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERB5 OUT."]
    CTMRB5 = 20,
    #[doc = "21: Clock source is CTIMERA0 OUT."]
    CTMRA0 = 21,
    #[doc = "22: Clock source is CTIMERB0 OUT."]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA5EN_A {
    #[doc = "0: Counter/Timer A5 Disable."]
    DIS = 0,
    #[doc = "1: Counter/Timer A5 Enable."]
    EN = 1,
}
...
impl<'a> TMRA5EN_W<'a> {
    ...
    #[doc = "Counter/Timer A5 Disable."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA5EN_A::DIS)
    }
    #[doc = "Counter/Timer A5 Enable."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
