...
pub enum CTLINK2_A {
    #[doc = "0: Use A2/B2 timers as two independent 16-bit timers (default)."]
    TWO_16BIT_TIMERS = 0,
...
impl<'a> CTLINK2_W<'a> {
    ...
    #[doc = "Use A2/B2 timers as two independent 16-bit timers (default)."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB2IE1_A {
    #[doc = "0: Disable counter/timer B2 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B2 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRB2IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer B2 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB2IE1_A::DIS)
    }
    #[doc = "Enable counter/timer B2 to generate an interrupt based on COMPR1."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB2IE0_A {
    #[doc = "0: Disable counter/timer B2 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B2 to generate an interrupt based on COMPR0"]
    EN = 1,
}
...
impl<'a> TMRB2IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer B2 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB2IE0_A::DIS)
    }
    #[doc = "Enable counter/timer B2 to generate an interrupt based on COMPR0"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
pub enum TMRB2FN_A {
    ...
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0B2, assert, count to CMPR1B2, deassert, stop."]
    PULSE_ONCE = 2,
...
impl<'a> TMRB2FN_W<'a> {
    ...
    #[doc = "Pulse once (aka one-shot). Count to CMPR0B2, assert, count to CMPR1B2, deassert, stop."]
    #[inline(always)]
...
pub enum TMRB2CLK_A {
    ...
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERA2 OUT."]
    CTMRA2 = 20,
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA2IE1_A {
    #[doc = "0: Disable counter/timer A2 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A2 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
impl<'a> TMRA2IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer A2 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA2IE1_A::DIS)
    }
    #[doc = "Enable counter/timer A2 to generate an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA2IE0_A {
    #[doc = "0: Disable counter/timer A2 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A2 to generate an interrupt based on COMPR0."]
    EN = 1,
}
...
impl<'a> TMRA2IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer A2 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA2IE0_A::DIS)
    }
    #[doc = "Enable counter/timer A2 to generate an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
pub enum TMRA2FN_A {
    ...
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0A2, assert, count to CMPR1A2, deassert, stop."]
    PULSE_ONCE = 2,
...
impl<'a> TMRA2FN_W<'a> {
    ...
    #[doc = "Pulse once (aka one-shot). Count to CMPR0A2, assert, count to CMPR1A2, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
...
pub enum TMRA2CLK_A {
    ...
    #[doc = "18: Clock source is XT / 32"]
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERB2 OUT."]
    CTMRB2 = 20,
    #[doc = "21: Clock source is CTIMERA3 OUT."]
    CTMRB3 = 21,
    #[doc = "22: Clock source is CTIMERB3 OUT."]
