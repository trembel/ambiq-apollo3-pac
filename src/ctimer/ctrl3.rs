...
pub enum CTLINK3_A {
    #[doc = "0: Use A3/B3 timers as two independent 16-bit timers (default)."]
    TWO_16BIT_TIMERS = 0,
...
impl<'a> CTLINK3_W<'a> {
    ...
    #[doc = "Use A3/B3 timers as two independent 16-bit timers (default)."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB3IE1_A {
    #[doc = "0: Disable counter/timer B3 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B3 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
#[doc = "Reader of field `TMRB3IE1`"]
pub type TMRB3IE1_R = crate::R<bool, TMRB3IE1_A>;
impl TMRB3IE1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRB3IE1`"]
...
impl<'a> TMRB3IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer B3 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB3IE1_A::DIS)
    }
    #[doc = "Enable counter/timer B3 to generate an interrupt based on COMPR1."]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRB3IE0_A {
    #[doc = "0: Disable counter/timer B3 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer B3 to generate an interrupt based on COMPR0"]
    EN = 1,
}
...
#[doc = "Reader of field `TMRB3IE0`"]
pub type TMRB3IE0_R = crate::R<bool, TMRB3IE0_A>;
impl TMRB3IE0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRB3IE0`"]
...
impl<'a> TMRB3IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer B3 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRB3IE0_A::DIS)
    }
    #[doc = "Enable counter/timer B3 to generate an interrupt based on COMPR0"]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
pub enum TMRB3FN_A {
    ...
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0B3, assert, count to CMPR1B3, deassert, stop."]
    PULSE_ONCE = 2,
...
impl<'a> TMRB3FN_W<'a> {
    ...
    #[doc = "Pulse once (aka one-shot). Count to CMPR0B3, assert, count to CMPR1B3, deassert, stop."]
    #[inline(always)]
...
pub enum TMRB3CLK_A {
    ...
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERA3 OUT."]
    CTMRA3 = 20,
    #[doc = "21: Clock source is CTIMERA2 OUT."]
    CTMRA2 = 21,
    #[doc = "22: Clock source is CTIMERB2 OUT."]
    CTMRB2 = 22,
    #[doc = "23: Clock source is CTIMERA4 OUT."]
    CTMRA4 = 23,
    #[doc = "24: Clock source is CTIMERB4 OUT."]
    CTMRB4 = 24,
...
impl TMRB3CLK_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, TMRB3CLK_A> {
        ...
        match self.bits {
            ...
            1 => Val(TMRB3CLK_A::HFRC_DIV4),
            2 => Val(TMRB3CLK_A::HFRC_DIV16),
            3 => Val(TMRB3CLK_A::HFRC_DIV256),
            4 => Val(TMRB3CLK_A::HFRC_DIV1024),
            5 => Val(TMRB3CLK_A::HFRC_DIV4K),
            6 => Val(TMRB3CLK_A::XT),
            7 => Val(TMRB3CLK_A::XT_DIV2),
            8 => Val(TMRB3CLK_A::XT_DIV16),
            9 => Val(TMRB3CLK_A::XT_DIV128),
            ...
            15 => Val(TMRB3CLK_A::HCLK_DIV4),
            16 => Val(TMRB3CLK_A::XT_DIV4),
            17 => Val(TMRB3CLK_A::XT_DIV8),
            18 => Val(TMRB3CLK_A::XT_DIV32),
            20 => Val(TMRB3CLK_A::CTMRA3),
            21 => Val(TMRB3CLK_A::CTMRA2),
            22 => Val(TMRB3CLK_A::CTMRB2),
            23 => Val(TMRB3CLK_A::CTMRA4),
            24 => Val(TMRB3CLK_A::CTMRB4),
            25 => Val(TMRB3CLK_A::CTMRB0),
            26 => Val(TMRB3CLK_A::CTMRB1),
            27 => Val(TMRB3CLK_A::CTMRB5),
            28 => Val(TMRB3CLK_A::CTMRB6),
            29 => Val(TMRB3CLK_A::BUCKBLE),
            30 => Val(TMRB3CLK_A::BUCKB),
            31 => Val(TMRB3CLK_A::BUCKA),
            i => Res(i),
        }
    }
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA3CLR_A {
    #[doc = "0: Allow counter/timer A3 to run"]
    RUN = 0,
...
impl<'a> TMRA3CLR_W<'a> {
    ...
    #[doc = "Allow counter/timer A3 to run"]
    #[inline(always)]
    pub fn run(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA3IE1_A {
    #[doc = "0: Disable counter/timer A3 from generating an interrupt based on COMPR1."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A3 to generate an interrupt based on COMPR1."]
    EN = 1,
}
...
#[doc = "Reader of field `TMRA3IE1`"]
pub type TMRA3IE1_R = crate::R<bool, TMRA3IE1_A>;
impl TMRA3IE1_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA3IE1`"]
...
impl<'a> TMRA3IE1_W<'a> {
    ...
    #[doc = "Disable counter/timer A3 from generating an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA3IE1_A::DIS)
    }
    #[doc = "Enable counter/timer A3 to generate an interrupt based on COMPR1."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TMRA3IE0_A {
    #[doc = "0: Disable counter/timer A3 from generating an interrupt based on COMPR0."]
    DIS = 0,
    #[doc = "1: Enable counter/timer A3 to generate an interrupt based on COMPR0."]
    EN = 1,
}
...
#[doc = "Reader of field `TMRA3IE0`"]
pub type TMRA3IE0_R = crate::R<bool, TMRA3IE0_A>;
impl TMRA3IE0_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Write proxy for field `TMRA3IE0`"]
...
impl<'a> TMRA3IE0_W<'a> {
    ...
    #[doc = "Disable counter/timer A3 from generating an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn dis(self) -> &'a mut W {
        self.variant(TMRA3IE0_A::DIS)
    }
    #[doc = "Enable counter/timer A3 to generate an interrupt based on COMPR0."]
    #[inline(always)]
    pub fn en(self) -> &'a mut W {
...
pub enum TMRA3FN_A {
    ...
    REPEATEDCOUNT = 1,
    #[doc = "2: Pulse once (aka one-shot).  Count to CMPR0A3, assert, count to CMPR1A3, deassert, stop."]
    PULSE_ONCE = 2,
...
impl<'a> TMRA3FN_W<'a> {
    ...
    #[doc = "Pulse once (aka one-shot). Count to CMPR0A3, assert, count to CMPR1A3, deassert, stop."]
    #[inline(always)]
    pub fn pulse_once(self) -> &'a mut W {
...
pub enum TMRA3CLK_A {
    ...
    #[doc = "18: Clock source is XT / 32"]
    XT_DIV32 = 18,
    #[doc = "20: Clock source is CTIMERB3 OUT."]
    CTMRB3 = 20,
    #[doc = "21: Clock source is CTIMERA2 OUT."]
    CTMRA2 = 21,
    #[doc = "22: Clock source is CTIMERB2 OUT."]
...
impl TMRA3CLK_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, TMRA3CLK_A> {
        ...
        match self.bits {
            ...
            1 => Val(TMRA3CLK_A::HFRC_DIV4),
            2 => Val(TMRA3CLK_A::HFRC_DIV16),
            3 => Val(TMRA3CLK_A::HFRC_DIV256),
            4 => Val(TMRA3CLK_A::HFRC_DIV1024),
            5 => Val(TMRA3CLK_A::HFRC_DIV4K),
            6 => Val(TMRA3CLK_A::XT),
            7 => Val(TMRA3CLK_A::XT_DIV2),
            8 => Val(TMRA3CLK_A::XT_DIV16),
            9 => Val(TMRA3CLK_A::XT_DIV128),
            ...
            15 => Val(TMRA3CLK_A::HCLK_DIV4),
            16 => Val(TMRA3CLK_A::XT_DIV4),
            17 => Val(TMRA3CLK_A::XT_DIV8),
            18 => Val(TMRA3CLK_A::XT_DIV32),
            20 => Val(TMRA3CLK_A::CTMRB3),
            21 => Val(TMRA3CLK_A::CTMRA2),
            22 => Val(TMRA3CLK_A::CTMRB2),
            23 => Val(TMRA3CLK_A::CTMRA4),
            24 => Val(TMRA3CLK_A::CTMRB4),
            25 => Val(TMRA3CLK_A::CTMRB0),
            26 => Val(TMRA3CLK_A::CTMRB1),
            27 => Val(TMRA3CLK_A::CTMRB5),
            28 => Val(TMRA3CLK_A::CTMRB6),
            29 => Val(TMRA3CLK_A::BUCKBLE),
            30 => Val(TMRA3CLK_A::BUCKB),
            31 => Val(TMRA3CLK_A::BUCKA),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `TMRPIN`"]
