...
pub enum TMRB5TRIG_A {
    ...
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERA5 OUT."]
    A5OUT = 1,
    ...
    A3OUT2 = 9,
    #[doc = "10: Trigger source is CTIMERA0 OUT2."]
    A0OUT2 = 10,
    #[doc = "11: Trigger source is CTIMERB0 OUT2."]
    B0OUT2 = 11,
...
impl<'a> TMRB5TRIG_W<'a> {
    ...
    #[doc = "Trigger source is CTIMERA0 OUT2."]
    #[inline(always)]
    pub fn a0out2(self) -> &'a mut W {
        self.variant(TMRB5TRIG_A::A0OUT2)
    }
    #[doc = "Trigger source is CTIMERB0 OUT2."]
    #[inline(always)]
...
pub enum TMRA5TRIG_A {
    #[doc = "0: Trigger source is disabled."]
    DIS = 0,
    #[doc = "1: Trigger source is STimer Interrupt.  Only Active When CTLINK==1 and TMRB5TRIG!=0.  TMRB5TRIG selects an STIMER interrupt"]
    STIMER = 1,
    #[doc = "2: Trigger source is CTIMERB3 OUT."]
    B3OUT = 2,
    #[doc = "3: Trigger source is CTIMERA3 OUT."]
    A3OUT = 3,
    #[doc = "4: Trigger source is CTIMERA4 OUT."]
    A4OUT = 4,
    #[doc = "5: Trigger source is CTIMERB4 OUT."]
    B4OUT = 5,
...
impl<'a> TMRA5TRIG_W<'a> {
    ...
    #[doc = "Trigger source is STimer Interrupt. Only Active When CTLINK==1 and TMRB5TRIG!=0. TMRB5TRIG selects an STIMER interrupt"]
    #[inline(always)]
