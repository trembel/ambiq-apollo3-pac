...
pub enum TMRB4TRIG_A {
    ...
    DIS = 0,
    #[doc = "1: Trigger source is CTIMERA4 OUT."]
    A4OUT = 1,
    #[doc = "2: Trigger source is CTIMERB3 OUT."]
    B3OUT = 2,
    #[doc = "3: Trigger source is CTIMERA3 OUT."]
    A3OUT = 3,
    #[doc = "4: Trigger source is CTIMERA7 OUT."]
    A7OUT = 4,
    #[doc = "5: Trigger source is CTIMERB7 OUT."]
    B7OUT = 5,
    #[doc = "6: Trigger source is CTIMERA1 OUT."]
    A1OUT = 6,
    #[doc = "7: Trigger source is CTIMERB1 OUT."]
    B1OUT = 7,
    #[doc = "8: Trigger source is CTIMERB3 OUT2."]
    B3OUT2 = 8,
    #[doc = "9: Trigger source is CTIMERA3 OUT2."]
    A3OUT2 = 9,
    #[doc = "10: Trigger source is CTIMERA1 OUT2."]
    A1OUT2 = 10,
    #[doc = "11: Trigger source is CTIMERB1 OUT2."]
    B1OUT2 = 11,
...
impl<'a> TMRB4TRIG_W<'a> {
    ...
    #[doc = "Trigger source is CTIMERA7 OUT."]
    #[inline(always)]
    pub fn a7out(self) -> &'a mut W {
        self.variant(TMRB4TRIG_A::A7OUT)
    }
    #[doc = "Trigger source is CTIMERB7 OUT."]
    #[inline(always)]
    ...
    #[doc = "Trigger source is CTIMERA1 OUT2."]
    #[inline(always)]
    pub fn a1out2(self) -> &'a mut W {
        self.variant(TMRB4TRIG_A::A1OUT2)
    }
    #[doc = "Trigger source is CTIMERB1 OUT2."]
    #[inline(always)]
...
pub enum TMRA4TRIG_A {
    #[doc = "0: Trigger source is disabled."]
    DIS = 0,
    #[doc = "1: Trigger source is STimer Interrupt.  Only Active When CTLINK==1 and TMRB4TRIG!=0.  TMRB4TRIG selects an STIMER interrupt"]
    STIMER = 1,
    #[doc = "2: Trigger source is CTIMERB3 OUT."]
    B3OUT = 2,
    #[doc = "3: Trigger source is CTIMERA3 OUT."]
    ...
    B6OUT = 5,
    #[doc = "6: Trigger source is CTIMERA2 OUT."]
    A2OUT = 6,
    #[doc = "7: Trigger source is CTIMERB2 OUT."]
    B2OUT = 7,
    #[doc = "8: Trigger source is CTIMERB3 OUT2."]
    B3OUT2 = 8,
    #[doc = "9: Trigger source is CTIMERA3 OUT2."]
...
impl<'a> TMRA4TRIG_W<'a> {
    ...
    #[doc = "Trigger source is STimer Interrupt. Only Active When CTLINK==1 and TMRB4TRIG!=0. TMRB4TRIG selects an STIMER interrupt"]
    #[inline(always)]
    ...
    #[doc = "Trigger source is CTIMERA2 OUT."]
    #[inline(always)]
