...
impl R {
    #[doc = "Bit 28 - Bit 28 of target byte address for source of CQ. Used to denote Flash (0) or SRAM (1) access"]
    #[inline(always)]
    pub fn cqaddr28(&self) -> CQADDR28_R {
        CQADDR28_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    #[doc = "Bits 2:19 - Bits 19:2 of target byte address for source of CQ. The buffer must be aligned on a word boundary"]
    #[inline(always)]
